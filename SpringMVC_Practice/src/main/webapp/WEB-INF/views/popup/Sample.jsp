...
function goPopup(){
	...
	/**절대경로**/
	var pop = window.open("/spring_ex_pjt/popup/jusoPopup","pop","width=570,height=420, scrollbars=yes, resizable=yes"); 
...
/* 		admCd, rnMgtSn, bdMgtSn,detBdNmList,bdNm,bdKdcd,siNm,sggNm,emdNm,liNm,rn,udrtYn,buldMnnm,buldSlno,mtYn,lnbrMnnm,lnbrSlno,emdNo */
